...
public class MemberController {
	...
	public String updateMember(
		...
		//1. 업무로직 : db의 Member 테이블에 회원정보 수정요청을 보낸 회원 정보 수정 => 생략
		...
		for(GrantedAuthority auth  :  oldAuthorites) {
			SimpleGrantedAuthority simpleAuth = new SimpleGrantedAuthority(auth.getAuthority());//문자열형태의 권한을 매개변수로 auth 객체 생성
